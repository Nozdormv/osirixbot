...
module.exports = {
  name: "camiseta", //the command name for execution & for helpcmd [OPTIONAL]
  category: "Commands", //the command category for helpcmd [OPTIONAL]
  aliases: ["camiseta"], //the command aliases for helpcmd [OPTIONAL]
  cooldown: 3, //the command cooldown for execution & for helpcmd [OPTIONAL]
  usage: "camiseta", //the command usage for helpcmd [OPTIONAL]
  description: "Camisetas en venta", //the command description for helpcmd [OPTIONAL]
      ...
      try{
        if (args[0]) {
          ...
          const embed = new MessageEmbed()
              ...
              .setFooter(`Camisetitas ricas en venta para ayudar a este calvo a comprar pañales`, client.user.displayAvatarURL());
