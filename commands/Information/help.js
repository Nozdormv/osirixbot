      ...
      try{
        if (args[0]) {
          ...
          const embed = new MessageEmbed()
              ...
              .setTitle("Ehh... aquí puedes ver todo lo que puedo hacer por ti... Pero... NO TE PASES GUARRO!")
              .setFooter(`Para ver descripciones e información de los comandos, escribe: ${config.prefix}help [CMD NAME]`, client.user.displayAvatarURL());
